...
def export_gaje_flat():
    ...
    for i in range(n_blocks):
        ...
        # 1. Fused QKV
        w_q = get_tensor_f32_matrix(tensors_by_name[f"blk.{i}.attn_q.weight"], n_head, head_dim, is_q_k=True)
        w_k = get_tensor_f32_matrix(tensors_by_name[f"blk.{i}.attn_k.weight"], n_head_kv, head_dim, is_q_k=True)
