...
def main():
    parser = argparse.ArgumentParser(
        description="🧬 GAJE Born-Genomic Training Phase 1"
    )
    parser.add_argument(
        "--name", type=str, default="GajeSmall-v1", help="Nombre del organismo"
    )
    ...
    parser.add_argument(
        "--epochs", type=int, default=50, help="Épocas de entrenamiento"
    )
    parser.add_argument("--lr", type=float, default=0.005, help="Learning Rate")
    parser.add_argument(
        "--dataset",
        type=str,
        default="data/datasets/dataset_born_2000.txt",
    ...
    print("[*] Iniciando entrenamiento Born-Genomic...")
