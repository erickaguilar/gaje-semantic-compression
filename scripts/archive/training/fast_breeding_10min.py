...
def main():
    ...
    print(f"🧬 Iniciando Sesión de CRIANZA PROFUNDA (60 minutos)")
    ...
    while (time.time() - start_time) < time_limit:
        ...
        for i, text in enumerate(lines):
            ...
            if count % 50 == 0:
                ...
                print(f"  - [{elapsed}s] Progreso: {count}/{len(lines)} | Loss: {loss:.4f}", end="\r")
        ...
        print(f"[*] Checkpoint 'Mature' actualizado.")

    print("\n" + "="*60)
    print(f"✅ CRIANZA PROFUNDA COMPLETADA")
