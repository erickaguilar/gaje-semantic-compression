...
def apply_recalibration(model_path, output_path, shift=0.1):
    ...
    print("[*] Aplicando Alineación de Vector en Equilibrio (VE) (strength=0.1)...")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", type=str, default="models/production/silver_adult_steel.gaje"
    )
    parser.add_argument(
        "--output", type=str, default="models/production/silver_adult_calibrated.gaje"
    )
