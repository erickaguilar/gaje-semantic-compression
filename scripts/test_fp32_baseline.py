...
def test_fp32_baseline():
    ...
    model_path = os.path.join(project_root, "data", "models", "qwen2-0_5b-instruct-fp16.gguf")
    ...
    messages = [{"role": "user", "content": "Responde únicamente con una palabra: capital de Francia"}]
    ...
    print("[*] Generando 10 tokens con motor nativo Rust GAJE (KV Cache Persistente)...")
    generated_tokens = []
