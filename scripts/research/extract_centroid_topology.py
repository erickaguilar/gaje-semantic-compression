...
class TopologyExtractor:
    ...
    def extract_cam(self, text_corpus, num_samples=100, seq_len=64):
        print(
            f"[*] Extrayendo Topología Relacional (Corpus: {len(text_corpus)} líneas)..."
        )
...
def run_step_1(model_id, data_path, output_path):
    ...
    print("[*] Próximo paso: Inyectar este mapa en el motor de Rust.")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Paso 1: Extracción de Topología Relacional"
    )
