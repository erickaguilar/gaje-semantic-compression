...
def identity_test():
    ...
    print(f"Quantizing to 2-bit GAJE...")
        ...
        for b in range(n_blocks):
            ...
            for k in range(stride):
                ...
                for s in range(4):
                    ...
                    if bits == 0b00: cent = block_centroids[0]
                    elif bits == 0b01: cent = block_centroids[1]
                    elif bits == 0b11: cent = block_centroids[2]
                    elif bits == 0b10: cent = block_centroids[3]
                    else: cent = 0.0
