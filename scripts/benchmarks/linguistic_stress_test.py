...
def run_stress_test(model_path):
    print(f"🔬 [DIAGNÓSTICO] Iniciando Stress Test Lingüístico")
    ...
    if variance < 0.2:
        ...
        print("   -> Causa: Falta de cobertura en los datos de calibración (Ruta A necesaria).")
    elif results["NIVEL 3: Técnico/Abstracto"] > results["NIVEL 1: Identidad/Simple"] * 5:
        print("🟡 COLAPSO POR RESOLUCIÓN: El modelo falla drásticamente al subir la complejidad.")
        print("   -> Causa: La ε-net de 2 bits no tiene resolución para el ancho de banda técnico (Ruta B necesaria).")
    else:
