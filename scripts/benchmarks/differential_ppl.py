...
def run_phase_2_1(gaje_path, es_data_path, en_data_path, num_samples=50):
    print(f"🚀 Iniciando Fase 2.1: Análisis de Sesgo Lingüístico (PPL Diferencial)")
    ...
    print("\n" + "="*60)
    print(f"📊 RESULTADO FINAL FASE 2.1")
    ...
    if gap >= 20:
        ...
        print(f"     Esto sugiere que el vocabulario o los centroides no están")
        print(f"     bien equilibrados para esta gramática.")
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--en_data", type=str, default="data/datasets/tiny_shakespeare.txt")
