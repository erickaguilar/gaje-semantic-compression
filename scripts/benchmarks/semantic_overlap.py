...
def run_phase_1_1(master_id, gaje_path, prompts, k=10):
    print(f"🚀 Iniciando Fase 1.1: Alineación de Centroides (Top-K Overlap)")
    ...
    try:
        master_model = AutoModelForCausalLM.from_pretrained(master_id, torch_dtype=torch.float32, device_map="cpu")
    ...
    print("\n" + "="*60)
    print(f"📊 RESULTADO FINAL FASE 1.1")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Fase 1.1: Validación de Overlap Semántico")
    parser.add_argument("--master", type=str, default="HuggingFaceTB/SmolLM2-135M", help="ID o ruta del modelo maestro")
    parser.add_argument("--gaje", type=str, default="models/checkpoints/smollm2_native.gaje", help="Ruta al archivo .gaje")
