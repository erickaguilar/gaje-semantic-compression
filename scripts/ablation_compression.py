...
experiments = [
    ("4-bit Uniform (4b Attn, 4b FFN)", 4, 4, -1.0),
    ("2-bit Uniform (2b Attn, 2b FFN)", 2, 2, -1.0),
    ("Mixed-Bit + 5% FFN Anchors (4b Attn, 2b FFN, 5% Anchors)", 4, 2, 0.05),
]

print("\n======================================================")
print("🔬 ABLACIÓN DE COMPRESIÓN Y ANCLAJE (SmolLM2-135M)")
print("======================================================")
