...
print(f"Test 1 (Without torch import): {dt1:.2f} ms total for {len(tokens)} tokens ({dt1/len(tokens):.2f} ms/tok)")
...
print(f"Test 2 (With torch imported):   {dt2:.2f} ms total for {len(tokens)} tokens ({dt2/len(tokens):.2f} ms/tok)")
