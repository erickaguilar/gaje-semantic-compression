...
impl SpikeEvent {
    ...
    pub fn new_py(
        ...
        phase_offset: u8,
        intensity: f32,
        source_neuron_id: usize,
        target_layer_id: usize,
        target_neuron_id: usize,
    ) -> Self {
        Self {
            timestamp,
            phase_offset,
    ...
    #[cfg(feature = "python")]
    #[getter]
    pub fn get_phase_offset(&self) -> u8 {
        self.phase_offset
    }
    #[cfg(feature = "python")]
    #[getter]
    ...
    #[cfg(feature = "python")]
    #[getter]
    pub fn get_source_neuron_id(&self) -> usize {
        self.source_neuron_id
    }
    #[cfg(feature = "python")]
    #[getter]
    pub fn get_target_layer_id(&self) -> usize {
        self.target_layer_id
    }
    #[cfg(feature = "python")]
    #[getter]
    pub fn get_target_neuron_id(&self) -> usize {
