...
fn _impl(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(
        crate::compute::math::quantize_embedding,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(crate::compute::math::quantize_pq, m)?)?;
    m.add_function(wrap_pyfunction!(
        crate::compute::math::dequantize_q8_0_native,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        crate::compute::math::genomize_f32_native,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
    ...
    m.add_function(wrap_pyfunction!(
        crate::compute::math::quantize_q2_0_native,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
    ...
    m.add_function(wrap_pyfunction!(
        crate::compute::math::quantize_phase_native,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        crate::compute::math::dequantize_phase_native,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        crate::compute::math::calculate_shannon_entropy,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
        crate::compute::math::calculate_genomic_entropy,
        m
    )?)?;
    m.add_function(wrap_pyfunction!(
