...
with gr.Blocks() as demo:
    ...
    This demo transforms real AI embeddings into 2-bit genomic strands (`00=A`, `01=C`, `11=G`, `10=T`).
    ...
    with gr.Row():
        with gr.Column():
            input_text = gr.Textbox(
                label="Input Text",
                placeholder="Enter a sentence to compress...",
                lines=3,
            )
    ...
    - **Model:** Qwen2-0.5B Coherent / Silver Adult (2-bit Max-Lloyd Centroids)
    ...
    **Authorship:** Erick Aguilar (Vision) & Gemini (Algorithm) | *Dios cuida de la humanidad.*
    ...
    btn.click(
        compress_demo,
        inputs=[input_text, model_dropdown],
        outputs=[output_dna, output_hex, output_metrics],
    )
