...
def main():
    ...
    base_entropy[outlier_indices] += np.random.normal(
        loc=1.5, scale=0.5, size=len(outlier_indices)
    )
    ...
    print("   - Al aislar los picos (rojos/amarillos) en vectores dispersos,")
    print("     el motor en Rust puede multiplicar la matriz verde a máxima")
    print("     velocidad vectorial sin penalización de bifurcación (branching).")
    print("=" * 60)
