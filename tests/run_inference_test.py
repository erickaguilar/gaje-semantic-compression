...
def run_inference_test(model_path, prompt, max_tokens=30, temperature=0.7, num_blocks=None):
    ...
    print(f"  -> Dimensiones: n_embd={llm.n_embd}, n_head={llm.n_head}, n_blocks={llm.n_blocks}")
    ...
    for token_text in llm.generate(prompt, max_new_tokens=max_tokens, temperature=temperature):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--max-tokens", type=int, default=30,
                        help="Numero maximo de tokens a generar")
