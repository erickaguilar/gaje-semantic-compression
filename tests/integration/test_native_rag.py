...
def test_native_rag():
    ...
    doc3 = (
        "La perplejidad del modelo Silver Adult disminuye con inhibición lateral K-WTA."
    )
    ...
    print("[*] Resultados de búsqueda para consulta 1:")
    ...
    assert (
        results[0][1] >= 0.999
    ), f"Similarity score should be ~1.0, got {results[0][1]}"
