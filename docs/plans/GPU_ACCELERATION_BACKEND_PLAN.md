...
### 🔹 Fase 1: Infraestructura y Detección de Dispositivos GPU (`src/compute/gpu/`) — ✅ COMPLETADA
* **Dependencias:** Integración de `wgpu` con backend nativo Vulkan / DX12 / Metal.
...
### 🔹 Fase 2: Shaders de Cómputo WGSL (`src/compute/gpu/shaders/`) — ✅ COMPLETADA
* **`gemv_f32.wgsl`:** Multiplicación Matriz-Vector paralela en workgroups.
...
### 🔹 Fase 3: Integración en `GenomicLinear` y `GenomicLLM` — ✅ COMPLETADA
