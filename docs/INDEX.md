...
* **[VIABILITY_ANALYSIS_GENOMIC_TOKENIZATION_GTOK_V2.md](research/VIABILITY_ANALYSIS_GENOMIC_TOKENIZATION_GTOK_V2.md)**: **ANÁLISIS DE VIABILIDAD GTOK v2.0** — Evaluación de los 3 pilares de tokenización y almacenamiento genómico: raíces morfológicas 4K + codones 2-bit, desambiguación hipocampal con `.gmem` y empaquetado zero-copy en `.flat`.
...
* **[QWEN_1_5B_PRODUCTION_RAG_CERTIFICATION.md](certifications/QWEN_1_5B_PRODUCTION_RAG_CERTIFICATION.md)**: **CERTIFICACIÓN RAG Y PROTOCOLO MCP DE QWEN2.5-1.5B** — Validación empírica E2E, centrado $\boldsymbol{\mu}+\ell_2$, separación $+16\%$, frontera limpia exacta $N \le 36$, análisis RoPE 1M y reposicionamiento en Q&A factual atómico.
...
* **[GAJE_SOVEREIGN_1B_Q2_GMEM_ARCHITECTURE_PLAN.md](plans/GAJE_SOVEREIGN_1B_Q2_GMEM_ARCHITECTURE_PLAN.md)**: **MODELO SOBERANO GAJE-SOVEREIGN-1B (Q2_0 + .GMEM)** — Especificación de arquitectura soberana de 1 Billón de parámetros en ~265 MB, cuerpo Q2_0 desacoplado de cabeza FP32/GTOK v2, y ampliación de conocimiento fáctico ilimitado mediante hipocampo mmap en Edge.
