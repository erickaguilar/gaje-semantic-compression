...
class GenomicDistiller:
    ...
    def __init__(self, model_path, num_blocks=1):
        ...
        print(f"🧬 Distiller: Cargando modelo Maestro (F32)...")
    ...
    def run_distillation_pipeline(self, prompts, output_dir="gaje_v2_premium"):
        print(f"🚀 Iniciando Pipeline de Destilación Integral (Fase 10).")
...
if __name__ == "__main__":
    ...
    distiller = GenomicDistiller(model_path, num_blocks=6)
    calibration_prompts = [
    ...
    distiller.run_distillation_pipeline(calibration_prompts, output_dir="gaje_v2_premium")
