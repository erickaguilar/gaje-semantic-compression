...
class SignalToNoiseBalancer:
    ...
    def generate_precision_mask(self, entropy_per_dim, fidelity_level=0.8):
        ...
        try:
            ...
            mask_bytes = dna_core.generate_precision_mask_native(entropy_per_dim.tolist(), fidelity_level)
    ...
    def prune_dimensions(self, database, stride, entropy_per_dim, threshold=0.01):
        ...
        try:
            active_dims = dna_core.get_active_dimensions_native(entropy_per_dim.tolist(), threshold)
