...
import json
try:
    from archive import GAJEArchive
except ImportError:
    from python.archive import GAJEArchive
try:
    from dna_semantic_compression import dna_semantic_compression as engine
except ImportError:
    import dna_semantic_compression as engine
...
def main():
    ...
    search_parser.add_argument("--dims", type=int, default=100, help="Vector dimensions")

    args = parser.parse_args()

    if args.command == "info":
        print("🧬 GAJE Protocol v0.2.0")
        print("Status: Edge-Ready")
