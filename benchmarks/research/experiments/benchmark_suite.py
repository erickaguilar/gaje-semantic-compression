...
def run_benchmarks():
    results = {"compression": {}, "latency": {}, "search_throughput": {}}
    ...
    db_dna = [
        dna_semantic_compression.quantize_embedding(row.tolist())
    ...
    with open("benchmarks/logs/raw_data.json", "w") as f:
        json.dump(results, f, indent=4)

    print("Results saved to benchmarks/logs/raw_data.json")
    return results
