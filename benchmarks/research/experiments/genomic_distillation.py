...
def run_distillation():
    ...
    print("🧬 Iniciando Destilación Genómica (Modo Lite)...")
    ...
    print("👶 Sincronizando Alumno Genómico (2-bit + Epigenética)...")
    student = GenomicLLM(model_path, num_blocks=30)

    test_text = "The capital of France is"
    tokens = tokenizer.encode(test_text)

    print("[*] Fase 1: Evaluación de Probabilidades Genómicas...")
    ...
    print("\n" + "=" * 45)
    print("📊 REPORTE DE EVOLUCIÓN (2-BIT)")
    print("=" * 45)
    ...
    if target_prob < 0.1:
        ...
        print(
            "   -> Acción: Re-calibrando centroides de Laplacian para capturar 'Paris'."
        )
