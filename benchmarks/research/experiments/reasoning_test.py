...
def run_reasoning_test():
    ...
    for task in tasks:
        ...
        if task["expected"].lower() in decoded.lower():
            ...
            print(
                "    Estado: ⚠️ DESVIACIÓN (La compresión de 2-bits puede afectar la precisión exacta)"
            )
        print("-" * 60)
    ...
    print(
        "El modelo de 2-bits con estabilización epigenética logra capturar la semántica básica."
    )
