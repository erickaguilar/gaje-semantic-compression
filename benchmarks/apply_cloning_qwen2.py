...
def apply_cloning_to_block():
    print("🧬 INICIANDO CLONACIÓN DE ANCLAS EN BLOQUE REAL")
    print("-" * 50)
    
    # Rutas de los archivos del bloque 0
    base_path = "dna-semantic-compression/gaje_qwen2_full_v1/block_0/"
