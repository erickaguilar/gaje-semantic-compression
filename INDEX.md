...
*   **[NATIVE_DISTILLATION_ROADMAP.md](docs/plans/NATIVE_DISTILLATION_ROADMAP.md)**: **CAMINO A SEGUIR.** Hoja de ruta para la Crianza Progresiva y Destilación.
*   **[OPERATION_REBIRTH.md](docs/plans/OPERATION_REBIRTH.md)**: Metodología de transmutación inicial.
*   **[NEXT_STEPS_2026.md](docs/plans/NEXT_STEPS_2026.md)**: Plan de choque para la Operación Rescate.
...
Utilidades de soporte para el ciclo de vida genómico.

*   **`scripts/maintenance/`**: Scripts de respaldo, consolidación de datasets y limpieza.
*   **`scripts/data_processing/`**: Generación de datasets sintéticos y balanceo semántico.
*   **`scripts/benchmarks/`**: Suite de evaluación de rendimiento y recuperación de datos (Needle Test).
